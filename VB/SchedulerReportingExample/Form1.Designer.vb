...
Namespace SchedulerReportingExample
	Partial Public Class Form1
		...
		Private Sub InitializeComponent()
            ...
            Me.appointmentsTableAdapter = New SchedulerReportingExample.AppointmentsTableAdapter()
            Me.resourcesTableAdapter = New SchedulerReportingExample.ResourcesTableAdapter()
        ...
        Private appointmentsTableAdapter As AppointmentsTableAdapter
		Private resourcesBindingSource As System.Windows.Forms.BindingSource
        Private resourcesTableAdapter As ResourcesTableAdapter
